...
namespace CosultorioDescktop.Migrations
{
    ...
    [Migration("20211115171149_modelBuilderParaTurnoDetalle2")]
    partial class modelBuilderParaTurnoDetalle2
    {
            ...
            modelBuilder.Entity("CosultorioDescktop.Models.TurnoDetalles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Hora = new DateTime(2021, 11, 15, 14, 11, 48, 629, DateTimeKind.Local).AddTicks(9802),
                            PacienteId = 1,
                            Precio = 300,
                            TipoTurno = 1
                        });

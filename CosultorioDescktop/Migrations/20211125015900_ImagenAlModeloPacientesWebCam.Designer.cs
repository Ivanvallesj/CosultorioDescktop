...
namespace ConsultorioDesktop.Migrations
{
    ...
    [Migration("20211125015900_ImagenAlModeloPacientesWebCam")]
    partial class ImagenAlModeloPacientesWebCam
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.Doctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.Paciente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.TurnoDetalles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Hora = new DateTime(2021, 11, 24, 22, 58, 59, 919, DateTimeKind.Local).AddTicks(8702),
                            PacienteId = 1,
                            Precio = 300,
                            TipoTurno = 1
                        });
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.Doctor", b =>
                {
                    b.HasOne("ConsultorioDesktop.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.Paciente", b =>
                {
                    b.HasOne("ConsultorioDesktop.Models.Doctor", "Doctor")
                        .WithMany("Pacientes")
            ...
            modelBuilder.Entity("ConsultorioDesktop.Models.TurnoDetalles", b =>
                {
                    ...
                    b.HasOne("ConsultorioDesktop.Models.Paciente", "Paciente")
                        .WithMany()
